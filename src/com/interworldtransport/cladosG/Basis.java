 ...
 * generators inclusive (with 16284 blades) because 2^15-1 is the max for signed
 * shorts and 15 generators produce 2^15 blades. Switching to int's enables up
 * to 30 generators and 1,073,741,824 blades. Switching to long's enables up to
 * 62 generators and 4,611,686,018,427,387,904 blades. Perhaps when that kind of
 * hardware is available, this class should be updated. 8)
 * <p>
 * There is a speed improvement for sorting keys in an Eddington basis if we use
 ...
 * Heapsort has been chosen here to leave room for the physical model being
 * implemented.
 * <p>
 ...
 * worrying about which sort is faster in filling a basis.
 * <p>
...
public final class Basis {
	...
	/**
	 * This is just a factory method to help name the copy constructor for Basis. It
	 * is used in place of 'new Basis(Basis)'.
	 * 
	 ...
	 */
	public static final Basis using(short numberOfGenerators) throws GeneratorRangeException {
	 ...
	 * 
	 * A column entry in a row is a generator (short) used to construct a blade. The
	 * generators in a row are sorted in ascending order. Only positive, non-zero
	 * integers represent generators.
	 * 
	 * A row of the array is a blade. The number of rows is the linear dimension of
	...
	/**
	 * This is the copy constructor. It takes a previously generated Basis and makes
	 ...
	 * @param vKey     long[]
	 * @param heapSize int
	 * @param point    int re-useable index on vKey needed because we recurse
	 */

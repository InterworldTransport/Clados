 ...
 * classes like a Cardinal. Some features are supported by the CladosField enumeration.
 * 
 * The DivField builder is a singleton enforced as an enumeration that keeps track 
 * of Cardinals and builds them as needed.
 * 
 * This enumeration has a non-static element for the instance, thus CladosFBuilder
 * HAS INTERNAL STATE that can change unlike the CladosField enumerator of DivFields
 * in the same package.
 *	
 * @version 1.0
...
{	// This has an implicit private constructor we won't override.
	...
	/**
	 * Heads Up! This ArrayList ensures this 'enumeration' is mutable.
	 * This class isn't intended to be static/immutable.
	 * It is supposed to be instantiated once and then used to keep 
	 * track of the Cardinals in use while performing a useful function
	 * as a Builder. It is doing DOUBLE DUTY.
	 */

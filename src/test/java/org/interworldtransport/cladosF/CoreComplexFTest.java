...
class CoreComplexFTest {
	...
	public void testMultiplyInvertPasses() throws FieldException {
		...
		assertDoesNotThrow(() -> ComplexF.isEqual(testThis.invert(), tComplex1));
	...
	public void testDivideByZero() {
		...
		assertThrows(FieldBinaryException.class, () -> ComplexF.divide(tComplex1, testThis));
	...
	public void testAddsThatShouldNotWork() {
		...
		assertThrows(FieldBinaryException.class, () -> ComplexF.add(testThis1, testThis2)); 	//Cardinal mismatch
		assertThrows(FieldBinaryException.class, () -> testThis1.add(testThis2));				//Cardinal mismatch

		assertThrows(FieldBinaryException.class, () -> ComplexF.add(testThis1, tComplex4));		//adding NaN
		assertThrows(FieldBinaryException.class, () -> ComplexF.add(testThis1, tComplex5));		//adding infinity
		assertThrows(FieldBinaryException.class, () -> ComplexF.add(testThis1, tComplex6));		//adding infinity
		assertDoesNotThrow(() -> ComplexF.add(testThis1, tComplex2));	//Nothing stops addition to Float.MAX_VALUE right now.
		assertDoesNotThrow(() -> ComplexF.add(testThis1, tComplex8));	//Nothing stops addition to Float.MIN_VALUE right now.
		...
		assertDoesNotThrow(() -> testThis1.add(tComplex2));	//Nothing stops addition to Float.MAX_VALUE right now.
		assertDoesNotThrow(() -> testThis1.add(tComplex8));	//Nothing stops addition to Float.MIN_VALUE right now.
	}
	...
	public void testSubtractionsThatShouldNotWork() {
		ComplexF testThis1 = ComplexF.copyZERO(tComplex1);
		ComplexF testThis2 = ComplexF.newONE(Cardinal.generate("PurposelyDifferent"));
		assertThrows(FieldBinaryException.class, () -> ComplexF.subtract(testThis1, testThis2)); 	//Cardinal mismatch
		assertThrows(FieldBinaryException.class, () -> testThis1.subtract(testThis2));				//Cardinal mismatch

		assertThrows(FieldBinaryException.class, () -> ComplexF.subtract(testThis1, tComplex4));		//subtract NaN
		assertThrows(FieldBinaryException.class, () -> ComplexF.subtract(testThis1, tComplex5));		//subtract infinity
		assertThrows(FieldBinaryException.class, () -> ComplexF.subtract(testThis1, tComplex6));		//subtract infinity
		assertDoesNotThrow(() -> ComplexF.subtract(testThis1, tComplex2));	//Nothing stops subtract of Float.MAX_VALUE right now.
		assertDoesNotThrow(() -> ComplexF.subtract(testThis1, tComplex8));	//Nothing stops subtract of Float.MIN_VALUE right now.
		...
		assertDoesNotThrow(() -> testThis1.subtract(tComplex2));	//Nothing stops subtract of Float.MAX_VALUE right now.
		assertDoesNotThrow(() -> testThis1.subtract(tComplex8));	//Nothing stops subtract of Float.MIN_VALUE right now.
	...
	public void testMultipliesThatShouldNotWork() {
		ComplexF testThis1 = ComplexF.copyZERO(tComplex1);
		//ComplexF testThis2 = ComplexF.newONE(Cardinal.generate("PurposelyDifferent"));
		//assertThrows(FieldBinaryException.class, () -> ComplexF.multiply(testThis1, testThis2)); 	//Cardinal mismatch
		//assertThrows(FieldBinaryException.class, () -> testThis1.multiply(testThis2));				//Cardinal mismatch

		assertThrows(FieldBinaryException.class, () -> ComplexF.multiply(testThis1, tComplex4));		//multiply NaN
		assertThrows(FieldBinaryException.class, () -> ComplexF.multiply(testThis1, tComplex5));		//multiply infinity
		assertThrows(FieldBinaryException.class, () -> ComplexF.multiply(testThis1, tComplex6));		//multiply infinity
		assertDoesNotThrow(() -> ComplexF.multiply(testThis1, tComplex2));	//Nothing stops multiply with Float.MAX_VALUE right now.
		assertDoesNotThrow(() -> ComplexF.multiply(testThis1, tComplex8));	//Nothing stops multiply with Float.MIN_VALUE right now.
		...
		assertDoesNotThrow(() -> testThis1.multiply(tComplex2));	//Nothing stops multiply with Float.MAX_VALUE right now.
		assertDoesNotThrow(() -> testThis1.multiply(tComplex8));	//Nothing stops multiply with Float.MIN_VALUE right now.
	}
	...
	public void testDividesThatShouldNotWork() { //Divide BY zero already tested elsewhere
		ComplexF testThis1 = ComplexF.copyZERO(tComplex1);
		//ComplexF testThis2 = ComplexF.newONE(Cardinal.generate("PurposelyDifferent"));
		//assertThrows(FieldBinaryException.class, () -> ComplexF.divide(testThis1, testThis2)); 		//Cardinal mismatch
		//assertThrows(FieldBinaryException.class, () -> testThis1.divide(testThis2));				//Cardinal mismatch

		assertThrows(FieldBinaryException.class, () -> ComplexF.divide(testThis1, tComplex4));		//divide by NaN
		assertThrows(FieldBinaryException.class, () -> ComplexF.divide(testThis1, tComplex5));		//divide by infinity
		assertThrows(FieldBinaryException.class, () -> ComplexF.divide(testThis1, tComplex6));		//divide by infinity
		assertDoesNotThrow(() -> ComplexF.divide(testThis1, tComplex2));	//Nothing stops divide by Float.MAX_VALUE right now.
		assertDoesNotThrow(() -> ComplexF.divide(testThis1, tComplex8));	//Nothing stops divide by Float.MIN_VALUE right now.
		...
		assertDoesNotThrow(() -> testThis1.divide(tComplex2));	//Nothing stops divide by Float.MAX_VALUE right now.
		assertDoesNotThrow(() -> testThis1.divide(tComplex8));	//Nothing stops divide by Float.MIN_VALUE right now.
	}
	...
	public void testCopyFromSQModuliSum() throws FieldBinaryException {
		...
		assertThrows(FieldBinaryException.class, () -> ComplexF.copySumSQModulus(tComplexs));
	
		ComplexF[] whatsThis = (ComplexF[]) FListBuilder.COMPLEXF.create(16);		//Default Cardinal
		assertDoesNotThrow(() -> ComplexF.copySumSQModulus(whatsThis));
		assertTrue(ComplexF.isZero(ComplexF.copySumSQModulus(whatsThis)));

		ComplexF[] whatsThis2 = (ComplexF[]) FListBuilder.COMPLEXF.createONE(16);	//Default Cardinal
	...
	public void testCopyFromModuliSum() throws FieldBinaryException {
		...
		assertThrows(FieldBinaryException.class, () ->ComplexF.copySumModulus(tComplexs));

		ComplexF[] whatsThis = (ComplexF[]) FListBuilder.COMPLEXF.create(16);		//Default Cardinal
		assertDoesNotThrow(() -> ComplexF.copySumModulus(whatsThis));

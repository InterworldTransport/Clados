 ...
 * ------------------------------------------------------------------------ <br>
 * ---org.interworldtransport.cladosGExceptions.GradeOutOfRangeException<br>
 * -------------------------------------------------------------------- <p>
...
public class GradeOutOfRangeException extends Exception {
	private static final long serialVersionUID = 2041586607013500378L;
	/**
	 ...
	 */
	public GradeOutOfRangeException(CanonicalBasis pSource, String pMessage) {
		super();
		Source = pSource;

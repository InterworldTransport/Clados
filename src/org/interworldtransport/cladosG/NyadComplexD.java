...
public class NyadComplexD extends NyadAbstract {
	...
	/**
	 * Simple copy constructor of a Nyad. The passed NyadComplexD will be copied in
	 ...
	 */
	public NyadComplexD(NyadComplexD pN) throws CladosNyadException, CladosMonadException {
	 ...
	 *                              being used/copied.
	 */
	public NyadComplexD(String pName, MonadComplexD pM, boolean pCopy)
	 ...
	 *                              monads in the nyad being copied.
	 */
	public NyadComplexD(String pName, NyadComplexD pN, boolean pCopy) throws CladosNyadException, CladosMonadException {
		setName(pName);
		setFoot(pN.getFoot());
	 ...
	 *                              being copied.
	 */
	public NyadComplexD appendMonadCopy(MonadComplexD pM) throws CladosNyadException, CladosMonadException {
		// This method works if the foot of pM matches the foot of this nyad
		...
		// Add Monad to the ArrayList
		monadList.ensureCapacity(monadList.size() + 1);
		monadList.add((MonadComplexD) CladosGMonad.COMPLEXD.copyOf(pM));
		resetAlgebraList(monadList);
		return this;
	}
	...
	public NyadComplexD createMonad(String pName, String pAlgebra, String pFrame, String pSig, String pCard)
		...
		MonadComplexD tM = (MonadComplexD) CladosGMonad.COMPLEXD
	...
	public int findAlgebra(Algebra pAlg) {
		for (MonadComplexD pM : getMonadList())
	 ...
	 * @return int
	 */
	public int findMonad(MonadComplexD pIn) {
		for (MonadComplexD pM : getMonadList())
			if (pIn == pM)
				return monadList.indexOf(pM);
		return -1;

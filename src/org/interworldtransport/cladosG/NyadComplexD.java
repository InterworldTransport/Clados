...
//	protected ArrayList<Monad> monadList;
	 ...
	 *                              being used/copied.
	 */
	public NyadComplexD(String pName, Monad pM, boolean pCopy)
	 ...
	 * @return NyadComplexD
	 */
//	public NyadComplexD appendMonad(Monad pM) throws CladosNyadException {
...
//	}
	 ...
	 *                              being copied.
	 */
//	public NyadComplexD appendMonadCopy(Monad pM) throws CladosNyadException, CladosMonadException {
//		// This method works if the foot of pM matches the foot of this nyad
...
//	}
	...
	public NyadComplexD createMonad(String pName, String pAlgebra, String pFrame, String pSig, String pCard)
		...
		Monad tM = CladosGBuilder.createMonadWithFoot(CladosFBuilder.COMPLEXD.createZERO(tCard),
...
//	}
	 ...
	 * @return NyadComplexD
	 */
//	public NyadComplexD removeMonad(Monad pM) throws CladosNyadException {

 ...
 * physics.
 * <p>
 * NyadComplexD objects must be declared with at least one Monad that has at
...
public class NyadComplexD extends NyadAbstract {
	 ...
	 * the Nyads must match except for the NyadComplexD names. The monads within the
	 * NyadComplexD must also be reference matches for pairs from the same algebra.
	 ...
	 * Nyads must match except for the NyadComplexD names and orders. The monads
	 * within the NyadComplexD must also be reference matches for pairs from the
	 * same algebra. It is NOT required that monads from this nyad have counterparts
	 * in the other nyad, so the passed NyadComplexDs may have a different order
	 ...
	 * changed.
	 * 
	 * @param pInto AlgebraComplexD
	 * @param pFrom AlgebraComplexD
	 ...
	 */
	/*
	 * public NyadComplexD antisymmCompress(AlgebraComplexD pInto, AlgebraComplexD
	...
	public NyadComplexD createMonad(String pName, String pAlgebra, String pFrame, String pSig, String pCard)
		...
		MonadComplexD tM;
		if (pCard == null)
			tM = new MonadComplexD(pName, pAlgebra, pFrame, getFoot(), pSig,
	 ...
	 * @return NyadComplexD
	 */
	// public NyadComplexD scale(AlgebraComplexD pk, ComplexD pMag) throws
	 ...
	 */
	/*
	 * public NyadComplexD symmCompress(AlgebraComplexD pInto, AlgebraComplexD
	 * pFrom) throws CladosNyadException { // The strings refer to particular
	 * algebras. Find them in the AlgebraKey // to know which two monads are being
	 * compress. Once that is done, do // the operation. int tempInto =
	 * findAlgebra(this, pInto); int tempFrom = findAlgebra(this, pFrom);

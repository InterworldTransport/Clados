 ...
 * ------------------------------------------------------------------------ <br>
 * ---org.interworldtransport.cladosG.AlgebraRealF<br>
 * -------------------------------------------------------------------- <p>
...
public class AlgebraRealF extends AlgebraAbstract {
	 ...
	 * being used to represent real numbers.
	 * 
	 * That's all.
	 */
	 ...
	 * takes the RealF number type from there. It takes in two strings (one name and
	 * a product signature) and the Foot and produces an AlgebraRealF. If anything

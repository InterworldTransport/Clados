...
public class NyadRealF extends NyadAbstract
{
	 ...
	 * @return int
	 */
	public static final int findAlgebra(NyadRealF pN, AlgebraAbstract pAlg)
	{
	 ...
	 * @return int
	 */
	public static final int findNextAlgebra(NyadRealF pN, AlgebraAbstract pAlg, int pStart)
	{
	 ...
	 * @return boolean
	 */
	public static final boolean hasAlgebra(NyadRealF pN, AlgebraAbstract pAlg)
	{
	 ...
	 *  monads in the nyad
	 */
	public static final int howManyAtAlgebra(NyadRealF pN, AlgebraAbstract pAlg)
	{
	 ...
	 * @return 	boolean
	 */
	public static final boolean isPScalarAt(NyadRealF pN, AlgebraAbstract pAlg)
	{
	 ...
	 * @return 	boolean
	 */
	public static final boolean isScalarAt(NyadRealF pN, AlgebraAbstract pAlg)
	{
		boolean test = false;	// Assume test fails
		if (pN.getMonadList().size()<=0) return false;	// No monads? Fails.

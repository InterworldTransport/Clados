...
//	protected ArrayList<Monad> monadList;
	 ...
	 *                              being used/copied.
	 */
	public NyadRealF(String pName, Monad pM, boolean pCopy) throws CladosNyadException, CladosMonadException {
	 ...
	 * @return NyadRealF
	 */
//	public NyadRealF appendMonad(Monad pM) throws CladosNyadException {
...
//	}
	 ...
	 *                              being copied.
	 */
//	public NyadRealF appendMonadCopy(Monad pM) throws CladosNyadException, CladosMonadException {
//		// This method works if the foot of pM matches the foot of this nyad
...
//	}
	...
	public NyadRealF createMonad(String pName, String pAlgebra, String pFrame, String pSig, String pCard)
		...
		Monad tM = CladosGBuilder.createMonadWithFoot(CladosFBuilder.REALF.createZERO(tCard),
...
//	}
	 ...
	 * @return NyadRealF
	 */
//	public NyadRealF removeMonad(Monad pM) throws CladosNyadException {

...
public class NyadRealF extends NyadAbstract {
	 ...
	 * @return int
	 */
	public static final int findAlgebra(NyadRealF pN, Algebra pAlg) {
	 ...
	 * @return int
	 */
	public static final int findNextAlgebra(NyadRealF pN, Algebra pAlg, int pStart) {
	 ...
	 * @return boolean
	 */
	public static final boolean hasAlgebra(NyadRealF pN, Algebra pAlg) {
	 ...
	 */
	public static final int howManyAtAlgebra(NyadRealF pN, Algebra pAlg) {
	 ...
	 * @return boolean
	 */
	public static final boolean isPScalarAt(NyadRealF pN, Algebra pAlg) {
	 ...
	 * @return boolean
	 */
	public static final boolean isScalarAt(NyadRealF pN, Algebra pAlg) {
		boolean test = false; // Assume test fails
		if (pN.getMonadList().size() <= 0)
			return false; // No monads? Fails.
	...
	/**
	 * Simple copy constructor of a NyadRealF. The passed NyadRealF will be copied
	 ...
	 * changed.
	 * 
	 * @param pInto AlgebraRealF
	 * @param pFrom AlgebraRealF
	...
	public NyadRealF createMonad(String pName, String pAlgebra, String pFrame, String pSig, String pCard)
		...
		MonadRealF tM;
		if (pCard == null)
			tM = new MonadRealF(pName, pAlgebra, pFrame, getFoot(), pSig,
					(RealF) CladosField.REALF.createZERO(getFoot().getCardinal(0)));
		else
			tM = new MonadRealF(pName, pAlgebra, pFrame, getFoot(), pSig, (RealF) CladosField.REALF.createZERO(pCard));
		appendMonad(tM);
		return this;
	}
	 ...
	 * @return NyadRealF
	 */
	// public NyadRealF scale(AlgebraRealF pk, RealF pMag) throws
	 ...
	 */
	/*
	 * public NyadRealF symmCompress(AlgebraRealF pInto, AlgebraRealF pFrom) throws

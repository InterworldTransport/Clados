...
public class MonadComplexF extends MonadAbstract {
	 ...
	 * @return String
	 */
	public static String toXMLString(MonadComplexF pM, String indent) {
		if (indent == null)
			indent = "\t\t\t";
	 ...
	 * @return String
	 */
	public static String toXMLFullString(MonadComplexF pM, String indent) {
		if (indent == null)
			indent = "\t\t\t";
		StringBuilder rB = new StringBuilder(indent + "<Monad ");
		rB.append("gradeKey=\"").append(pM.getGradeKey()).append("\" ");
	...
	public MonadComplexF(String pMonadName, String pAlgebraName, String pFrameName, String pFootName, String pSig,
		...
		cM = (ComplexF[]) CladosFListBuilder.COMPLEXF.create(getAlgebra().shareCardinal(), getAlgebra().getBladeCount());
		setGradeKey();
	}
	...
	public MonadComplexF conjugate() {
		this.bladeStream().parallel().forEach(k -> cM[k].conjugate());
		return this;
	}
	...
	public void setCoeff(ComplexF[] ppC) throws CladosMonadException {
		...
		cM = (ComplexF[]) CladosFListBuilder.COMPLEXF.copyOf(ppC);
		setGradeKey();
	}

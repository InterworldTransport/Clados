 ...
 * ------------------------------------------------------------------------ <br>
 * ---org.interworldtransport.cladosG.AlgebraRealD<br>
 * -------------------------------------------------------------------- <p>
...
public class AlgebraRealD extends AlgebraAbstract {
	 ...
	 * are being used to represent real numbers.
	 * 
	 * That's all.
	 */
	 ...
	 */
	public AlgebraRealD(String pS, AlgebraRealD pA) {
		setAlgebraName(pS);
		protoNumber = (RealD) CladosField.REALD.createONE(pA.protoNumber.getCardinal());
	 ...
	 * takes the RealD number type from there. It takes in two strings (one name and
	 * a product signature) and the Foot and produces an AlgebraRealD. If anything
	 * is wrong with the signature it throws an exception. Any other error throws a
	 * general monad exception.
	 * 
	 ...
	 */
	public AlgebraRealD(String pS, Foot pF, Cardinal pCard, String pSig)
	 ...
	 *                                 number of generators is out of range.
	 */
	public AlgebraRealD(String pS, Foot pF, String pSig, DivField pDiv)
			throws BadSignatureException, GeneratorRangeException {
		setAlgebraName(pS);
		protoNumber = (RealD) CladosField.REALD.createONE(pDiv.getCardinal());
		setFoot(pF);
		foot.appendCardinal(protoNumber.getCardinal());
		setGProduct(new GProduct(pSig));
		gBasis = gProduct.getBasis();
	 ...
	 *                                 number of generators is out of range.
	 */
	public AlgebraRealD(String pS, String pFootName, String pSig, DivField pF)
			throws BadSignatureException, GeneratorRangeException {
		setAlgebraName(pS);
		protoNumber = (RealD) CladosField.REALD.createONE(pF.getCardinal());
